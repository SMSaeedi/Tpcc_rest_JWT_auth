...
public class Payment_Vx177 {
    ...
    public PaymentResult paymentTransaction(PaymentModel input) {
        ...
        try {
            ...
            ps43.setString(2, input.getC_w_id());
            ...
            PreparedStatement ps57 = con.prepareStatement(
                    "SELECT w_street_1, w_street_2, w_city, w_state, w_zip, w_name" +
                            "  FROM tpcc_warehouse" +
                            " WHERE w_id = ? ");
            ps57.setString(1, input.getC_w_id());
            ...
            ps78.setString(2, input.getC_w_id());
            ps78.setString(3, input.getC_d_id());
            ...
            PreparedStatement ps91 = con.prepareStatement(
                    "SELECT d_street_1, d_street_2, d_city, d_state, d_zip, d_name " +
                            ...
                            " WHERE d_w_id = ? " +
                            "   AND d_id = ? ");
            ps91.setString(1, input.getC_w_id());
            ps91.setString(2, input.getC_d_id());
            ...
            Logging.trace("input=" + input + c_credit);
            if (c_credit.equals("BC")) {
                PreparedStatement ps212 = con.prepareStatement(
                        "SELECT c_data " +
                                ...
                                "   AND c_d_id = ? " +
                                "   AND c_id = ? ");
                ps212.setString(1, input.getC_w_id());
                ps212.setString(2, input.getC_d_id());
                ps212.setString(3, input.getC_id());
...
//                ps257.setString(5, c_id);
            ...
            ps290.setString(4, input.getC_d_id());
            ps290.setString(5, input.getC_w_id());
