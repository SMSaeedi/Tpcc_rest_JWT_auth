...
public class Payment_Vx057 {
    ...
    public PaymentResult paymentTransaction(PaymentModel input) {
        ...
        try {
            ...
            query.append(input.getW_id()).append("'");
            ...
            if (input.isC_by_name()) {
                ...
                ps177.setString(3, input.getC_d_id());
            ...
            if (c_credit.equals("BC")) {
                ...
                rs.close();
                rs = null;
                c_new_data = "'" + input.getC_w_id() + "' '" + input.getC_d_id() + "' '" + input.getC_w_id() + "' '" + input.getD_id() + "' '" + input.getW_id() + "' " + input.getH_amount() + " |";
